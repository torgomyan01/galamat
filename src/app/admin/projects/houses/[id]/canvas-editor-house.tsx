...
function CanvasEditorHouse({ objectInfo, house }: IThisProps) {
            ...
            !polygons.some((_p) => _p.id === floor.id) ? (
              ...
              >
                ...
                <Button
                  size="sm"
                  color="primary"
                  className="mt-4 absolute left-4 bottom-4"
                  onPress={() => createNewObject(floor.id)}
                >
                  Выбрать
                </Button>
              </div>
...
export default CanvasEditorHouse;
